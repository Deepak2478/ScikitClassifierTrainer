...
-- changeset deepak.sharma:PR-1-0
...
-- changeset deepak.sharma:PR-1-1
-- comment training data schema
...
-- changeset deepak.sharma:PR-1-2
-- comment training data schema
CREATE TABLE `model` (
`id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- changeset deepak.sharma:PR-1-3
-- comment training data schema
...
-- changeset deepak.sharma:PR-1-4
-- comment training data schema
...
-- changeset deepak.sharma:PR-1-5
...
-- changeset deepak.sharma:PR-1-6
...
-- changeset deepak.sharma:PR-1-7
-- comment insert the api key
INSERT INTO api_key (`application_name`, `api_key`, `token_validity`)
