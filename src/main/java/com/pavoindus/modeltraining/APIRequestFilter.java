...
public class APIRequestFilter implements Filter {
    ...
    private boolean validateRequest(HttpServletRequest request) throws IOException {
        ...
        if (apiKeyObject != null && authToken != null) {
            ...
            String response = HttpUtil.getInstance().call( authProperties.getUrl() + "/" + authProperties.getTokenValidationUrl(), new ObjectMapper().writeValueAsString(params), headers, HttpUtil.POST);
